...
#
# Generated by export_simulation on Mon Dec 16 09:18:31 CST 2019
#
################################################################################
...
'-reset_run' switch to the './ROM8k.sh' script.
...
./ROM8k.sh -noclean_files

For more information on the script, please type './ROM8k.sh -help'.

...
#
# Generated by export_simulation on Mon Jan 14 18:03:07 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './ZBMem.sh' script.
...
./ZBMem.sh -noclean_files

For more information on the script, please type './ZBMem.sh -help'.
